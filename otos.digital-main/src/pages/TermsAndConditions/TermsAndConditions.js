...
import OtosLogo from '../../images/base_logo_transparent_background.webp';
    ...
    <div>
      ...
      <Container>
        <div className="legal-logo">
          <Image src={OtosLogo} width={500} />
          <h1>Mentions légales et politique de confidentialité</h1>
        </div>
        <br />
        <p>
          L'entreprise individuelle <strong>Nizar M'rad</strong>, soucieuse des
          droits des individus, notamment au regard des traitements automatisés
          et dans une volonté de transparence avec ses clients, a mis en place
          une politique reprenant l’ensemble de ces traitements, des finalités
          ...
          <br /> La version actuellement en ligne de ces conditions
        ...
        <br />
        <p>
          L'entreprise individuelle Nizar M'rad <br />
          <br /> Située: 22 rue du révérend père christian Gilbert, 92600
          Asnières-sur-Seine <br />
          <br />
          Immatriculé au RCS de Nanterre 83761995600019 <br />
          <br /> n° de téléphone : 0033674979756 <br />
          <br />
          adresse mail :{' '}
          <a href="mailto:contact@otos-lab.fr">contact@otos-lab.fr</a>
        </p>
        <br />
        <h3>1.3 Hébergeur (ci-après « l'hébergeur ») :</h3>
        <br />
        <p>
          Otos Lab est hébergé par LWS - Service Top Hébergement, dont le siège
          social est situé 10 rue Penthievre 75008 Paris France.
        </p>
        <br />
        ...
        <p>
          ...
          <br /> - suspendre, interrompre ou limiter l'accès à tout ou partie du
          site, réserver l'accès au site, ou à certaines parties du site, à une
          catégorie déterminée d'internautes ;<br />
        ...
        <p>
          ...
          <br />- du fait de l'usage du site ou de tout service accessible via
          Internet ;<br />
        ...
        <br />
        <p>
          Vos données sont collectées par l'entreprise individuelle
          <strong>Nizar M'rad</strong>.<br />
          <br />
        ...
        <ul>
          ...
          personnel, les utilisateurs disposent des droits suivants :<br />
          <br />
          <li>
        ...
        <p>
          ...
          :<br />
          <br /> 22 rue du révérend père christian Gilbert , 92600
          Asnières-sur-Seine .<br />
          <br /> Ou par email, à l’adresse :<br />
          <br /> <a href="mailto:contact@otos-lab.fr">
            contact@otos-lab.fr
          </a>{' '}
          <br />
          <br />
        ...
        <p>
          ...
          suivantes :<br />
          <br /> - accès et utilisation de la Plateforme par l'utilisateur ;
          <br />
          <br /> - gestion du fonctionnement et optimisation de la Plateforme ;
          <br />
          <br /> - mise en œuvre d'une assistance utilisateurs ;<br />
          <br /> - vérification, identification et authentification des données
          transmises par l'utilisateur ;<br />
          <br /> - personnalisation des services en affichant des publicités en
          ...
          sécurité ;<br />
          <br /> - gestion des éventuels litiges avec les utilisateurs ;<br />
        ...
        <p>
          ...
          <br />
          <br /> Dans la mesure raisonnablement nécessaire ou requise pour
          satisfaire aux obligations légales ou réglementaires, régler des
          litiges, empêcher les fraudes et abus ou appliquer nos modalités et
          ...
          compte ou que nous n'ayons plus besoin pour vous fournir nos services.
        </p>
        <br />
        ...
        <p>
          ...
          de la Plateforme, des informations accessibles au public ;<br />
          <br /> - quand l'utilisateur autorise le site web d'un tiers à accéder
          à ses données ;<br />
        ...
        <p>
          ...
          suivant : Lien ou adresse e-mail.
          <br />
          <br /> Vos données sont susceptibles d’être utilisées par les
          partenaires de l'éditeur à des fins de prospection commerciale, si
          vous ne le souhaitez pas, veuillez cliquer sur le lien suivant : Lien
          ou adresse e-mail.
          <br />
          <br /> Si, lors de la consultation du site, vous accédez à des données
          à caractère personnel, vous devez vous abstenir de toute collecte, de
          ...
          <br />
          <br /> Les données sont conservées et utilisées pour une durée
        ...
        <p>
          ...
          <br /> Un « Cookie » ou traceur est un fichier électronique déposé sur
          ...
          <br />
          <br /> Le cas échéant, des « cookies » émanant de l'éditeur du site
          ...
          mois. L'utilisateur a la possibilité de désactiver les cookies à tout
          moment.
          <br />
          <br />
          ...
          web ou les vidéos YouTube comme support pour ses annonces ; <br />
          <br />
